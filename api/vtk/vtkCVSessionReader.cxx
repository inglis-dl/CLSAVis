...
vtkCxxRevisionMacro( vtkCVSessionReader, "$Revision: $" );
vtkStandardNewMacro( vtkCVSessionReader );
...
//-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-
CVSession* vtkCVSessionReader::GetOutput(int idx)
{
  return CVSession::SafeDownCast( this->GetOutputDataObject( idx ) );
} 

//-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-
void vtkCVSessionReader::SetOutput( CVSession *output )
{
  this->GetExecutive()->SetOutputData( 0, output );
} 

//-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-
int vtkCVSessionReader::RequestDataObject(
  vtkInformation* request,
  vtkInformationVector **inputVector,
  vtkInformationVector *outputVector)
{
  CVSession *output = CVSession::New();
...
//-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-
int vtkCVSessionReader::ProcessRequest(
  vtkInformation *request,
  vtkInformationVector **inputVector,
  vtkInformationVector *outputVector)
{
      ...
      0 == outInfo->Get( vtkStreamingDemandDrivenPipeline::UPDATE_PIECE_NUMBER() ) )
  {
    ...
    CVSession* output = CVSession::SafeDownCast( outInfo->Get( vtkDataObject::DATA_OBJECT() ) );

    try
    {
      vtkstd::runtime_error e( "Error reading CLSAVis session file." );
      ...
      while( this->ParseNode() )
        if( XML_READER_TYPE_ELEMENT == this->CurrentNode.NodeType &&
            0 == xmlStrcmp( BAD_CAST "CVSession", this->CurrentNode.Name ) ) break;

      // if we never found the session element then throw an exception
      if( XML_READER_TYPE_ELEMENT != this->CurrentNode.NodeType ||
          0 != xmlStrcmp( BAD_CAST "CVSession", this->CurrentNode.Name ) )
        throw vtkstd::runtime_error( "File does not contain a CVSession element." );
      ...
      while( this->ParseNode() )
      {
        ...
        else
        {
          vtkWarningMacro(
            ...
            "\" while reading CVSession." );
        }
      }

      // warn if any expected elements were not found
      if( !cameraFound )
        vtkWarningMacro( "Expected element \"Camera\" was not found while reading CVSession." );
...
//-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-
int vtkCVSessionReader::FillOutputPortInformation( int, vtkInformation* info )
{
  info->Set( vtkDataObject::DATA_TYPE_NAME(), "CVSession" );
  return 1;
}

//-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-
void vtkCVSessionReader::Read( vtkCamera* camera )
{
  // list of expected elements
